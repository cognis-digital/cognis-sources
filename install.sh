#!/usr/bin/env sh
# Universal installer for cognis-sources. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/cognis-sources.git"
echo "Installing cognis-sources ..."
...
echo "Done. Run: cognis-sources --help"
